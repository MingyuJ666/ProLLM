...
parser.add_argument('--total_train', type=int, default=80000, help='Total samples to generate for training')
parser.add_argument('--total_test', type=int, default=20000, help='Total samples to generate for testing')
