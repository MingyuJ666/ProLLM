...
parser.add_argument('--input_file', type=str, default='protein.actions.SHS27K.txt', help='Path to the input file')
parser.add_argument('--train_file', type=str, default='SHS27K_train.csv', help='Path to the output training file')
parser.add_argument('--test_file', type=str, default='SHS27K_test.csv', help='Path to the output testing file')
...
parser.add_argument('--total_train', type=int, default=5000, help='Total samples to generate for training')
parser.add_argument('--total_test', type=int, default=1000, help='Total samples to generate for testing')
...
# Process the file and load data into memory
...
# Build graphs for training and testing sets
