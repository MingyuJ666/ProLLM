...
parser.add_argument('--input_file', type=str, default='protein.actions.STRING.txt', help='Path to the input file')
parser.add_argument('--train_file', type=str, default='STRING_train.csv', help='Path to the output training file')
parser.add_argument('--test_file', type=str, default='STRING_test.csv', help='Path to the output testing file')
...
parser.add_argument('--total_train', type=int, default=50000, help='Total samples to generate for training')
parser.add_argument('--total_test', type=int, default=8000, help='Total samples to generate for testing')
