...
input_file_path = "protein.actions.SHS27K.txt"  # Update this path
output_file_path = "SHS27K.txt"  # Update this path
...
with open("SHS27K_10.csv", mode="w", newline='') as tra:
  with open("posi_SHS27K_10.csv", mode="w", newline='') as pos:
    with open("neg_SHS27K_10.csv",  mode="w", newline='') as neg:
...
data = pd.read_csv('SHS27K_10.csv')
train_data, test_data = train_test_split(data, test_size=0.2)
train_data.to_csv('SHS27K_train_10.csv', index=False)
test_data.to_csv('SHS27K_test_10.csv', index=False)