...
input_file_path = "protein.actions.STRING.txt"  # Update this path
output_file_path = "STRING.txt"  # Update this path
...
with open("STRING_10.csv", mode="w", newline='') as tra:
  with open("posi_STRING_10.csv", mode="w", newline='') as pos:
    with open("neg_STRING_10.csv",  mode="w", newline='') as neg:
...
data = pd.read_csv('STRING_10.csv')
train_data, test_data = train_test_split(data, test_size=0.2)
train_data.to_csv('STRING_train_10.csv', index=False)
test_data.to_csv('STRING_test_10.csv', index=False)